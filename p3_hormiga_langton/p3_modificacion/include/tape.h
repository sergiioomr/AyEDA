...
class Tape {
	...
	// Every derived tape must implement its methods to viewing and changing the color of a cell and recolocate an ant when reached the limits of the tape
		...
		// Methods to print the tape correctly. The slide vector starts in negative index sometimes, so the for must be initialize with the min index, not always with 0
